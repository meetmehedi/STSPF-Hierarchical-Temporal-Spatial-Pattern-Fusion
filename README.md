...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **HTSPF_Full** | **78.25 ± 0.38** | *Ref.* | *Ref.* | *Ref.* | **82.9** | **0.50** |
...
| Model | Accuracy (%) | Δ (pp) | *p*-value | Sig. | Sparsity (%) | GFLOPs |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **HTSPF_Full** | **96.21 ± 0.05** | *Ref.* | *Ref.* | *Ref.* | **82.2** | **0.50** |
...
| Model | Accuracy (%) | Δ (pp) | *p*-value | Sig. | Sparsity (%) | GFLOPs |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **HTSPF_Full** | **75.56 ± 0.65** | *Ref.* | *Ref.* | *Ref.* | **82.8** | **0.50** |
...
| Model | Accuracy (%) | Δ (pp) | *p*-value | Sig. | Sparsity (%) | GFLOPs |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **HTSPF_Full** | **94.50 ± 0.10** | *Ref.* | *Ref.* | *Ref.* | **83.2** | **0.50** |
...
| Model | Accuracy (%) | Δ (pp) | *p*-value | Sig. | Sparsity (%) | GFLOPs |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **HTSPF_Full** | **82.33 ± 0.30** | *Ref.* | *Ref.* | *Ref.* | **81.7** | **0.50** |
